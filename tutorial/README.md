...
First make sure [`wgbstools`](https://github.com/nloyfer/wgbs_tools#installation) is installed and found in `$PATH`.
Second, "install" UXM. Only git clone is required. Optionally, add the "uxm" main scrip to your `$PATH`.
```bash
